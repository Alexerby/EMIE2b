...
pxweb_query_list <- 
  list("ContentsCode"=c("PR0101F1"),
       "Tid"=c(
         "1987M01","1987M02","1987M03","1987M04","1987M05","1987M06","1987M07","1987M08","1987M09","1987M10","1987M11","1987M12",
         "1988M01","1988M02","1988M03","1988M04","1988M05","1988M06","1988M07","1988M08","1988M09","1988M10","1988M11","1988M12",
         "1989M01","1989M02","1989M03","1989M04","1989M05","1989M06","1989M07","1989M08","1989M09","1989M10","1989M11","1989M12",
         "1990M01","1990M02","1990M03","1990M04","1990M05","1990M06","1990M07","1990M08","1990M09","1990M10","1990M11","1990M12",
         "1991M01","1991M02","1991M03","1991M04","1991M05","1991M06","1991M07","1991M08","1991M09","1991M10","1991M11","1991M12",
         "1992M01","1992M02","1992M03","1992M04","1992M05","1992M06","1992M07","1992M08","1992M09","1992M10","1992M11","1992M12",
         "1993M01","1993M02","1993M03","1993M04","1993M05","1993M06","1993M07","1993M08","1993M09","1993M10","1993M11","1993M12",
         "1994M01","1994M02","1994M03","1994M04","1994M05","1994M06","1994M07","1994M08","1994M09","1994M10","1994M11","1994M12",
         "1995M01","1995M02","1995M03","1995M04","1995M05","1995M06","1995M07","1995M08","1995M09","1995M10","1995M11","1995M12",
...
cpif_ts <- ts(cpif_df[, "cpif"], start = 1987, frequency = 12) 


# Create first origin
origin_1 <- 2002 + 11/12

n_origins <- length(window(cpif_ts, start = origin_1, end = 2020 + 10/12))
...
models_forecast <- function(hmax) {
    ...
    for (i in 1:n_origins) {
        ...
        dat <- window(cpif_ts, end = origin) # subsetting our ts up to above defined origin
